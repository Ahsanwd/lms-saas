...
const warmAcademyPages = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        order: 3,
        data: [
          { name: 'Amina R.', role: 'Parent', quote: 'My daughter runs to class every week — she\'s never been this excited about learning.', avatarUrl: null },
          { name: 'Noah T.', role: 'Student', quote: 'It feels like a second family here, not just a classroom.', avatarUrl: null },
          { name: 'Grace L.', role: 'Parent', quote: 'The instructors genuinely care. You can feel it in every class.', avatarUrl: null },
        ],
      },
      {
        type: 'cta',
