...
const SECTION_TYPES = ['hero', 'about', 'coursesSection', 'testimonials', 'cta', 'contact', 'custom', 'contactForm', 'courseApplication', 'team', 'bundlesSection', 'membershipPlansSection'];
