...
function ApproveModal({
  ...
  const isValid = isPartial
    ? amountCents > 0 && amountCents <= maxCents
    : true;

  function handleSubmit() {
    onConfirm(isPartial ? amountCents : null);
  }
        ...
        <div className="space-y-3">
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            <span className="text-sm font-medium text-gray-800">
              Full refund — {formatAmount(maxCents, currency)}
            </span>
          </label>
          <label className="flex items-center gap-2 cursor-pointer">
            <input
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mt-0.5">Review and action student refund requests</p>
      </div>
                  ...
                  {requests.map((r) => {
                    ...
                    return (
                      <tr key={r._id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-4 py-3">
                          <p className="text-gray-900 max-w-[160px] truncate">
                            {r.courseId?.title ?? '—'}
                          </p>
