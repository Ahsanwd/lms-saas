...
const NAV_ENTRIES: NavEntry[] = [
  ...
  // ── Admin ──────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { href: '/admin/payment-proofs', label: 'Payment Proofs', icon: <ReceiptIcon />, roles: ['tenant_admin', 'instructor'] },
    ],
  },

  // ── Guides (standalone, one per role — only one ever matches a given user) ─
  { href: '/guides/admin',      label: 'Admin Guide',      icon: <GuideIcon />, roles: ['tenant_admin'] },
  { href: '/guides/instructor', label: 'Instructor Guide', icon: <GuideIcon />, roles: ['instructor'] },
  { href: '/guides/student',    label: 'Student Guide',    icon: <GuideIcon />, roles: ['student'] },
